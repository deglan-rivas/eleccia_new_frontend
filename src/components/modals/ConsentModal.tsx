      ...
      <div className="relative top-20 mx-auto p-5 border w-[800px] shadow-lg rounded-md bg-white">
        <div className="mt-3">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              onClick={onClose}
              className="text-gray-500 hover:text-gray-700 flex-shrink-0 hover:cursor-pointer ml-4"
            >
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md focus:outline-none focus:ring-2 transition-colors ${
                isLoading 
                  ...
                  : 'bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-300 hover:cursor-pointer'
              }`}
            >
              Cancelar
            </button>
            <button
              ...
              className={`px-4 py-2 text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 transition-colors flex items-center ${
                isLoading
                  ...
                  : 'bg-green-600 hover:bg-green-700 hover:cursor-pointer focus:ring-green-500'
              }`}
            >
              {isLoading ? (
                <>
